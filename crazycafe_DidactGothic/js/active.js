    ...
    if ($.fn.owlCarousel) {
      ...
      if ($(window).width() > 768) {
        ...
        $(".hero_slider").on('translate.owl.carousel', function() {
          $('.slider_text h1').removeClass('bounceInDown animated').hide();
          $('.slider_text h2').removeClass('bounceInDown animated').hide();
          $('.slider_text p').removeClass('bounceInDown animated').hide();
          $('.slider_text .slider_btn').removeClass('bounceInDown animated').hide();
        });
        $(".hero_slider").on('translated.owl.carousel', function() {
          $('.owl-item.active .slider_text h1').addClass('bounceInDown animated').show();
          $('.owl-item.active .slider_text h2').addClass('bounceInDown animated').show();
          $('.owl-item.active .slider_text p').addClass('bounceInDown animated').show();
          $('.owl-item.active .slider_text .slider_btn').addClass('bounceInDown animated').show();
        });
