    ...
    if ($.fn.owlCarousel) {
      ...
      if ($(window).width() > 768) {
        ...
        $(".hero_slider").on('translate.owl.carousel', function() {
          $('.slider_text h1').removeClass('zoomIn animated').hide();
          $('.slider_text h2').removeClass('zoomIn animated').hide();
          $('.slider_text p').removeClass('zoomIn animated').hide();
          $('.slider_text .slider_btn').removeClass('zoomIn animated').hide();
        });
        $(".hero_slider").on('translated.owl.carousel', function() {
          $('.owl-item.active .slider_text h1').addClass('zoomIn animated').show();
          $('.owl-item.active .slider_text h2').addClass('zoomIn animated').show();
          $('.owl-item.active .slider_text p').addClass('zoomIn animated').show();
          $('.owl-item.active .slider_text .slider_btn').addClass('zoomIn animated').show();
        });
