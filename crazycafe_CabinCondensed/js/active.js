    ...
    if ($.fn.owlCarousel) {
      ...
      if ($(window).width() > 768) {
        ...
        $(".hero_slider").on('translate.owl.carousel', function() {
          $('.slider_text h1').removeClass('fadeInUp animated').hide();
          $('.slider_text h2').removeClass('fadeInUp animated').hide();
          $('.slider_text p').removeClass('fadeInUp animated').hide();
          $('.slider_text .slider_btn').removeClass('fadeInUp animated').hide();
        });
        $(".hero_slider").on('translated.owl.carousel', function() {
          $('.owl-item.active .slider_text h1').addClass('fadeInUp animated').show();
          $('.owl-item.active .slider_text h2').addClass('fadeInUp animated').show();
          $('.owl-item.active .slider_text p').addClass('fadeInUp animated').show();
          $('.owl-item.active .slider_text .slider_btn').addClass('fadeInUp animated').show();
        });
