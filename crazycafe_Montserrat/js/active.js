    ...
    if ($.fn.owlCarousel) {
      ...
      if ($(window).width() > 768) {
        ...
        $(".hero_slider").on('translate.owl.carousel', function() {
          $('.slider_text h1').removeClass('lightSpeedIn animated').hide();
          $('.slider_text h2').removeClass('lightSpeedIn animated').hide();
          $('.slider_text p').removeClass('lightSpeedIn animated').hide();
          $('.slider_text .slider_btn').removeClass('lightSpeedIn animated').hide();
        });
        $(".hero_slider").on('translated.owl.carousel', function() {
          $('.owl-item.active .slider_text h1').addClass('lightSpeedIn animated').show();
          $('.owl-item.active .slider_text h2').addClass('lightSpeedIn animated').show();
          $('.owl-item.active .slider_text p').addClass('lightSpeedIn animated').show();
          $('.owl-item.active .slider_text .slider_btn').addClass('lightSpeedIn animated').show();
        });
