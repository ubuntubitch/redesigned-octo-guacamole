    ...
    if ($.fn.owlCarousel) {
      ...
      if ($(window).width() > 768) {
        ...
        $(".hero_slider").on('translate.owl.carousel', function() {
          $('.slider_text h1').removeClass('fadeInUpBig animated').hide();
          $('.slider_text h2').removeClass('fadeInUpBig animated').hide();
          $('.slider_text p').removeClass('fadeInUpBig animated').hide();
          $('.slider_text .slider_btn').removeClass('fadeInUpBig animated').hide();
        });
        $(".hero_slider").on('translated.owl.carousel', function() {
          $('.owl-item.active .slider_text h1').addClass('fadeInUpBig animated').show();
          $('.owl-item.active .slider_text h2').addClass('fadeInUpBig animated').show();
          $('.owl-item.active .slider_text p').addClass('fadeInUpBig animated').show();
          $('.owl-item.active .slider_text .slider_btn').addClass('fadeInUpBig animated').show();
        });
