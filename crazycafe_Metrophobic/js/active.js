    ...
    if ($.fn.owlCarousel) {
      ...
      if ($(window).width() > 768) {
        ...
        $(".hero_slider").on('translate.owl.carousel', function() {
          $('.slider_text h1').removeClass('bounceInUp animated').hide();
          $('.slider_text h2').removeClass('bounceInUp animated').hide();
          $('.slider_text p').removeClass('bounceInUp animated').hide();
          $('.slider_text .slider_btn').removeClass('bounceInUp animated').hide();
        });
        $(".hero_slider").on('translated.owl.carousel', function() {
          $('.owl-item.active .slider_text h1').addClass('bounceInUp animated').show();
          $('.owl-item.active .slider_text h2').addClass('bounceInUp animated').show();
          $('.owl-item.active .slider_text p').addClass('bounceInUp animated').show();
          $('.owl-item.active .slider_text .slider_btn').addClass('bounceInUp animated').show();
        });
