    ...
    if ($.fn.owlCarousel) {
      ...
      if ($(window).width() > 768) {
        ...
        $(".hero_slider").on('translate.owl.carousel', function() {
          $('.slider_text h1').removeClass('fadeInRight animated').hide();
          $('.slider_text h2').removeClass('fadeInRight animated').hide();
          $('.slider_text p').removeClass('fadeInRight animated').hide();
          $('.slider_text .slider_btn').removeClass('fadeInRight animated').hide();
        });
        $(".hero_slider").on('translated.owl.carousel', function() {
          $('.owl-item.active .slider_text h1').addClass('fadeInRight animated').show();
          $('.owl-item.active .slider_text h2').addClass('fadeInRight animated').show();
          $('.owl-item.active .slider_text p').addClass('fadeInRight animated').show();
          $('.owl-item.active .slider_text .slider_btn').addClass('fadeInRight animated').show();
        });
