    ...
    if ($.fn.owlCarousel) {
      ...
      if ($(window).width() > 768) {
        ...
        $(".hero_slider").on('translate.owl.carousel', function() {
          $('.slider_text h1').removeClass('bounceInLeft animated').hide();
          $('.slider_text h2').removeClass('bounceInLeft animated').hide();
          $('.slider_text p').removeClass('bounceInLeft animated').hide();
          $('.slider_text .slider_btn').removeClass('bounceInLeft animated').hide();
        });
        $(".hero_slider").on('translated.owl.carousel', function() {
          $('.owl-item.active .slider_text h1').addClass('bounceInLeft animated').show();
          $('.owl-item.active .slider_text h2').addClass('bounceInLeft animated').show();
          $('.owl-item.active .slider_text p').addClass('bounceInLeft animated').show();
          $('.owl-item.active .slider_text .slider_btn').addClass('bounceInLeft animated').show();
        });
