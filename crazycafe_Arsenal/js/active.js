    ...
    if ($.fn.owlCarousel) {
      ...
      if ($(window).width() > 768) {
        ...
        $(".hero_slider").on('translate.owl.carousel', function() {
          $('.slider_text h1').removeClass('fadeInDown animated').hide();
          $('.slider_text h2').removeClass('fadeInDown animated').hide();
          $('.slider_text p').removeClass('fadeInDown animated').hide();
          $('.slider_text .slider_btn').removeClass('fadeInDown animated').hide();
        });
        $(".hero_slider").on('translated.owl.carousel', function() {
          $('.owl-item.active .slider_text h1').addClass('fadeInDown animated').show();
          $('.owl-item.active .slider_text h2').addClass('fadeInDown animated').show();
          $('.owl-item.active .slider_text p').addClass('fadeInDown animated').show();
          $('.owl-item.active .slider_text .slider_btn').addClass('fadeInDown animated').show();
        });
