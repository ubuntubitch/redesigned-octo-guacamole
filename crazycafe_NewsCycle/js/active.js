    ...
    if ($.fn.owlCarousel) {
      ...
      if ($(window).width() > 768) {
        ...
        $(".hero_slider").on('translate.owl.carousel', function() {
          $('.slider_text h1').removeClass('slideInUp animated').hide();
          $('.slider_text h2').removeClass('slideInUp animated').hide();
          $('.slider_text p').removeClass('slideInUp animated').hide();
          $('.slider_text .slider_btn').removeClass('slideInUp animated').hide();
        });
        $(".hero_slider").on('translated.owl.carousel', function() {
          $('.owl-item.active .slider_text h1').addClass('slideInUp animated').show();
          $('.owl-item.active .slider_text h2').addClass('slideInUp animated').show();
          $('.owl-item.active .slider_text p').addClass('slideInUp animated').show();
          $('.owl-item.active .slider_text .slider_btn').addClass('slideInUp animated').show();
        });
