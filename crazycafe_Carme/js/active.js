    ...
    if ($.fn.owlCarousel) {
      ...
      if ($(window).width() > 768) {
        ...
        $(".hero_slider").on('translate.owl.carousel', function() {
          $('.slider_text h1').removeClass('bounceIn animated').hide();
          $('.slider_text h2').removeClass('bounceIn animated').hide();
          $('.slider_text p').removeClass('bounceIn animated').hide();
          $('.slider_text .slider_btn').removeClass('bounceIn animated').hide();
        });
        $(".hero_slider").on('translated.owl.carousel', function() {
          $('.owl-item.active .slider_text h1').addClass('bounceIn animated').show();
          $('.owl-item.active .slider_text h2').addClass('bounceIn animated').show();
          $('.owl-item.active .slider_text p').addClass('bounceIn animated').show();
          $('.owl-item.active .slider_text .slider_btn').addClass('bounceIn animated').show();
        });
