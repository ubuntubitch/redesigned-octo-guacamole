    ...
    if ($.fn.owlCarousel) {
      ...
      if ($(window).width() > 768) {
        ...
        $(".hero_slider").on('translate.owl.carousel', function() {
          $('.slider_text h1').removeClass('slideInDown animated').hide();
          $('.slider_text h2').removeClass('slideInDown animated').hide();
          $('.slider_text p').removeClass('slideInDown animated').hide();
          $('.slider_text .slider_btn').removeClass('slideInDown animated').hide();
        });
        $(".hero_slider").on('translated.owl.carousel', function() {
          $('.owl-item.active .slider_text h1').addClass('slideInDown animated').show();
          $('.owl-item.active .slider_text h2').addClass('slideInDown animated').show();
          $('.owl-item.active .slider_text p').addClass('slideInDown animated').show();
          $('.owl-item.active .slider_text .slider_btn').addClass('slideInDown animated').show();
        });
