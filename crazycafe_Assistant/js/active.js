    ...
    if ($.fn.owlCarousel) {
      ...
      if ($(window).width() > 768) {
        ...
        $(".hero_slider").on('translate.owl.carousel', function() {
          $('.slider_text h1').removeClass('fadeInLeft animated').hide();
          $('.slider_text h2').removeClass('fadeInLeft animated').hide();
          $('.slider_text p').removeClass('fadeInLeft animated').hide();
          $('.slider_text .slider_btn').removeClass('fadeInLeft animated').hide();
        });
        $(".hero_slider").on('translated.owl.carousel', function() {
          $('.owl-item.active .slider_text h1').addClass('fadeInLeft animated').show();
          $('.owl-item.active .slider_text h2').addClass('fadeInLeft animated').show();
          $('.owl-item.active .slider_text p').addClass('fadeInLeft animated').show();
          $('.owl-item.active .slider_text .slider_btn').addClass('fadeInLeft animated').show();
        });
