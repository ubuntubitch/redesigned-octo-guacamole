    ...
    if ($.fn.owlCarousel) {
      ...
      if ($(window).width() > 768) {
        ...
        $(".hero_slider").on('translate.owl.carousel', function() {
          $('.slider_text h1').removeClass('zoomInDown animated').hide();
          $('.slider_text h2').removeClass('zoomInDown animated').hide();
          $('.slider_text p').removeClass('zoomInDown animated').hide();
          $('.slider_text .slider_btn').removeClass('zoomInDown animated').hide();
        });
        $(".hero_slider").on('translated.owl.carousel', function() {
          $('.owl-item.active .slider_text h1').addClass('zoomInDown animated').show();
          $('.owl-item.active .slider_text h2').addClass('zoomInDown animated').show();
          $('.owl-item.active .slider_text p').addClass('zoomInDown animated').show();
          $('.owl-item.active .slider_text .slider_btn').addClass('zoomInDown animated').show();
        });
