    ...
    if ($.fn.owlCarousel) {
      ...
      if ($(window).width() > 768) {
        ...
        $(".hero_slider").on('translate.owl.carousel', function() {
          $('.slider_text h1').removeClass('slideInRight animated').hide();
          $('.slider_text h2').removeClass('slideInRight animated').hide();
          $('.slider_text p').removeClass('slideInRight animated').hide();
          $('.slider_text .slider_btn').removeClass('slideInRight animated').hide();
        });
        $(".hero_slider").on('translated.owl.carousel', function() {
          $('.owl-item.active .slider_text h1').addClass('slideInRight animated').show();
          $('.owl-item.active .slider_text h2').addClass('slideInRight animated').show();
          $('.owl-item.active .slider_text p').addClass('slideInRight animated').show();
