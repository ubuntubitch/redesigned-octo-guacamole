    ...
    if ($.fn.owlCarousel) {
      ...
      if ($(window).width() > 768) {
        ...
        $(".hero_slider").on('translate.owl.carousel', function() {
          $('.slider_text h1').removeClass('zoomInRight animated').hide();
          $('.slider_text h2').removeClass('zoomInRight animated').hide();
          $('.slider_text p').removeClass('zoomInRight animated').hide();
          $('.slider_text .slider_btn').removeClass('zoomInRight animated').hide();
        });
        $(".hero_slider").on('translated.owl.carousel', function() {
          $('.owl-item.active .slider_text h1').addClass('zoomInRight animated').show();
          $('.owl-item.active .slider_text h2').addClass('zoomInRight animated').show();
          $('.owl-item.active .slider_text p').addClass('zoomInRight animated').show();
          $('.owl-item.active .slider_text .slider_btn').addClass('zoomInRight animated').show();
        });
